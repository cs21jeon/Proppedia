...
### 비공개 테스트 진행 (필수)
Google Play 정책에 따라 새 개발자 계정은 프로덕션 출시 전 비공개 테스트 필수
...
| 테스트 기간 | 최소 **14일** 이상 |
| 테스터 수 | 최소 **20명** |
| 테스터 활동 | 14일 동안 지속적으로 옵트인 상태 유지 |

### 진행 순서
1. [ ] **테스터 20명 모집** (가족, 친구, 지인, 커뮤니티)
2. [ ] **비공개 테스트 트랙 생성** (Play Console → 테스트 및 출시 → 비공개 테스트)
